      ...
      <div className="relative max-w-4xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
        ...
        >
          ...
          >
            <a
              href={APP_STORE_URL}
              className="inline-flex items-center gap-3 bg-black text-white font-mono text-base font-semibold px-10 py-5 rounded-2xl hover:bg-black/85 transition-all hover:scale-[1.02] active:scale-[0.98] whitespace-nowrap"
            >
