  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-20 pb-16 overflow-hidden">
      ...
      <motion.img
        ...
        className="w-52 h-auto mb-8 drop-shadow-lg"
      />
      ...
      <motion.h1
        ...
        className="text-5xl sm:text-6xl md:text-7xl font-bold text-center max-w-2xl leading-tight"
      >
        We&apos;re Hiring!
      </motion.h1>
      ...
      <motion.p
        ...
        className="font-mono text-sm sm:text-base text-text-primary/50 text-center mt-6 max-w-lg leading-relaxed"
      >
