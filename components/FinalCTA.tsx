    ...
    <section className="relative py-24 px-6" style={{ background: "var(--card-bg)" }}>
      ...
      <div className="relative max-w-2xl mx-auto text-center">
        ...
        >
          <a
            href={APP_STORE_URL}
            className="inline-flex items-center justify-center gap-3 bg-black text-white font-mono text-[13px] sm:text-base font-semibold px-5 sm:px-10 py-4 sm:py-5 rounded-2xl hover:bg-black/85 transition-all hover:scale-[1.02] active:scale-[0.98] w-full sm:w-auto"
          >
            <svg className="w-7 h-7 sm:w-5 sm:h-5" viewBox="0 0 24 24" fill="currentColor">
